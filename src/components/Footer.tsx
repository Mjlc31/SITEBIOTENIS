      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="col-span-1 md:col-span-1">
          ...
          <div className="flex gap-4">
            <a href="#" className="text-gray-400 hover:text-[#C89B3C] transition-colors">
              <Instagram size={20} />
            </a>
            <a href="#" className="text-gray-400 hover:text-[#C89B3C] transition-colors">
              <Facebook size={20} />
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-gray-400">
            ...
            <li className="flex items-center gap-3 hover:text-white transition-colors cursor-pointer">
              <Phone size={18} className="text-[#C89B3C] shrink-0" />
              <span>(82) 3328-0000</span>
            </li>
            <li className="flex items-center gap-3 hover:text-white transition-colors cursor-pointer">
              <Mail size={18} className="text-[#C89B3C] shrink-0" />
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-gray-400">
            <li><Link to="/" className="hover:text-[#C89B3C] transition-colors">A Academia</Link></li>
            <li><Link to="/reservas" className="hover:text-[#C89B3C] transition-colors">Reservar Quadra</Link></li>
            <li><Link to="/aulas" className="hover:text-[#C89B3C] transition-colors">Aulas</Link></li>
            <li><Link to="/pro-shop" className="hover:text-[#C89B3C] transition-colors">Pro Shop</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <form className="flex" onSubmit={(e) => e.preventDefault()}>
            <input 
              ...
              className="bg-[#050505] border border-white/10 px-4 py-2 text-sm w-full focus:outline-none focus:border-[#C89B3C] transition-colors"
            />
            <button className="bg-[#C89B3C] hover:bg-[#b08732] text-black px-4 font-medium transition-colors">
              Assinar
            </button>
          </form>
        </div>
