...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-50 border-t border-slate-200 py-16 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="col-span-1 md:col-span-1">
          ...
          <div className="flex gap-4">
            <a href="#" className="text-slate-500 hover:text-[#cc4f33] transition-colors">
              <Instagram size={20} />
            </a>
            <a href="#" className="text-slate-500 hover:text-[#cc4f33] transition-colors">
              <Facebook size={20} />
        ...
        <div>
          <h4 className="font-heading text-sm tracking-widest uppercase text-slate-900 mb-6">Contato</h4>
          <ul className="space-y-4 text-sm text-slate-600">
            <li className="flex items-start gap-3 hover:text-slate-900 transition-colors cursor-pointer">
        ...
        <div>
          <h4 className="font-heading text-sm tracking-widest uppercase text-slate-900 mb-6">Navegação</h4>
        ...
        <div>
          <h4 className="font-heading text-sm tracking-widest uppercase text-slate-900 mb-6">Newsletter</h4>
          <p className="text-slate-600 text-sm mb-4">Receba novidades sobre torneios e clínicas.</p>
          <form className="flex relative" onSubmit={handleSubscribe}>
            <input 
              type="email" 
              placeholder="Seu melhor e-mail" 
              className="bg-white border border-slate-300 rounded-lg px-4 py-2 text-sm w-full focus:outline-none focus:border-[#cc4f33] transition-colors pr-24 text-slate-900"
              required
            />
            <button type="submit" className="absolute right-0 top-0 bottom-0 bg-[#cc4f33] rounded-r-lg hover:bg-[#e06042] text-white px-4 font-medium transition-colors flex items-center justify-center">
      ...
      <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-slate-200 flex flex-col md:flex-row items-center justify-between text-xs text-slate-500">
